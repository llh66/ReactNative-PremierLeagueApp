...
import { initializeFavoriteTeam } from '../utils/FirebaseDBHelper';
        ...
        try {
            await createUserWithEmailAndPassword(FIREBASE_AUTH, userObject.email, userObject.password)
                .then((result) => {
                    ...
                    initializeFavoriteTeam(result.user.email);
                });
        } catch (err) {
            setUserObject({
                ...userObject,
    ...
    return (
        <View style={[globalStyles.container, styles.container]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={styles.subtitle}>Join us by creating your account!</Text>
            </View>
